...
namespace UnitTestProject1
{
    ...
    public class TestBalancedTree<TTree> where TTree : ITree, new()
    {
        ITree lst = new TTree();
        ...
        [TestCase(new int[] { 3, 7, 1, 0, 9, 2, 8 }, new int[] { 3, 8, 1, 0, 7, 9 }, 2)]
        [TestCase(new int[] { 3, 7, 1, 0, 9, 2, 8 }, new int[] { 3, 8, 1, 0, 2, 7 }, 9)]
        [TestCase(new int[] { 3, 7, 1, 0, 9, 2, 8 }, new int[] { 3, 8, 1, 0, 2, 9 }, 7)]
        [TestCase(new int[] { 3, 7, 1, 0, 9, 2, 8 }, new int[] { 2, 8, 1, 0, 7, 9 }, 3)] 
